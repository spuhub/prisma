...
class DataProcessing():
    ...
    def data_preprocessing(self, operation_config):
        ...
        lyr_reproj = layer_reproject(lyr_input, 4326)
        lyr_reproj.setName(lyr_input.name())
        ...
        dic_lyr_retorno = {'input': lyr_reproj, 'required': list_required, 'db': list_selected_db, 'shp': list_selected_shp, 'wfs': list_selected_wfs}
